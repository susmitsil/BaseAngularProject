var app = angular.module('CotrustAdminUIApp', ['ngCookies', 'ngResource', 'ngStorage', 'ngMessages', 'ngRoute', 'mgcrea.ngStrap','monospaced.qrcode','smart-table','ngProgress','ngAnimate','ngMaterialDatePicker'])
